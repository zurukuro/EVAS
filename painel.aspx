        ...
        <form id="frmPainel" runat="server">
            <section class="panel-flex">
                <section class="panel">
                    ...
                    <asp:Button Text="" runat="server" ID="btnPerfil" CssClass="nome-arduino therm-name" />
                    <asp:Button Text="Dudu" runat="server" CssClass="nome-arduino therm-name" ID="btnDudu" />
