                ...
                <div class="row row-center">
                    <div class="col-6">
                        <form runat="server" id="frmContato" class="form">
                            <div>
                                <asp:TextBox runat="server" ID="txtNomeCompleto" CssClass="input" MaxLength="50" placeholder="Nome Completo" />
                            </div>

                            <div>
                                <asp:TextBox runat="server" ID="txtEmail" CssClass="input" MaxLength="50" placeholder="Email" />
                            </div>

                            <div>
                                <asp:DropDownList runat="server" ID="ddlAssunto" CssClass="input">
                                    <asp:ListItem Text="-- Selecione --" />
                                    <asp:ListItem Text="Suporte Tecnico" />
                                    <asp:ListItem Text="Duvidas sobre o produto" />
                ...
                <div class="col-5">
                    <h4 class="footer__title">Sobre nós</h4>
                        ...
                        <p class="footer__text">
                            <br/>
                            Alguns direitos reservados, 2018 | Website feito com <span class="footer__color">❤</span> por <a href="index.html" class="footer__color">EVAS</a></p>
                </div>
                <div class="col-4">
                ...
                <div class="col-3">
                    ...
                    <div class="social-media">
                        <a href="#" class="icon-link">
                            <svg class="icon-footer icon-facebook2">
                        ...
                        <a href="#" class="icon-link">
                            <svg class="icon-footer icon-instagram">
